 ...
 * Use the {@link CheckoutUserFragment#newInstance} factory method to
...
public class CheckoutUserFragment extends Fragment {
     ...
     * @return A new instance of fragment CheckoutUserFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static CheckoutUserFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), FormAlamatActivity.class);
